let array = [1, 20, 2, 3, [5, 40], [2, 5, 6, 7, 8], 3];
// 0   1   2  3    4           5           6
...
// console.log(array.splice(2, 3)); // returns removed elements && first parameter is index and second parameter is number of elements to remove
// console.log(array.sort((a, b) => b - a)); // returns sorted array
...
// console.log(array.reduce((x, y) => x + y , 10)); // returns single value && applies function to each element
// console.log(array.every((x) => x > 1)); // returns boolean && applies function to each element
// console.log(array.some((x) => x > 1000)); // returns boolean
...
// console.log(array.includes(322)); // returns boolean
